...
<div class="section section-antivirus">
	<form id="antivirus" action="#" method="post">
		<fieldset class="personalblock">
		    ...
		    <p class="av_socket"><label for="av_socket"><?php p($l->t('Socket'));?></label><input type="text" id="av_socket" name="avSocket" value="<?php p($_['avSocket']); ?>" style="margin-left: 3px;" title="<?php p($l->t('Clamav Socket.')).' '.$l->t('Not required in Executable Mode.'); ?>"></p>
			...
			<p class="av_stream_max_length">
				...
				/>
				<label for="av_stream_max_length" class="a-left" style="min-width: 0px;"><?php p($l->t('bytes'))?></label>
			</p>
			<p class="av_path">
			...
			<p class="av_max_file_size">
				...
				/>
				<label for="av_max_file_size" class="a-left" style="min-width: 0px;"><?php p($l->t('bytes'))?></label>
			</p>
